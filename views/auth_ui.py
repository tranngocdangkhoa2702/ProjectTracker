...
class AuthFrame(ctk.CTkFrame):
    ...
    def show_login(self):
        ...
        ctk.CTkLabel(self, text="Theo dõi đồ án", font=("Segoe UI", 30, "bold"), text_color=("#1d4ed8", "#60a5fa")).pack(pady=(46, 6))
        ctk.CTkLabel(
            self,
        ...
        ctk.CTkLabel(
            self,
            text="Tài khoản mới cần quản trị viên kích hoạt trước khi đăng nhập.",
            font=("Segoe UI", 11),
    ...
    def show_register(self):
        ...
        ctk.CTkLabel(self, text="Tạo tài khoản", font=("Segoe UI", 30, "bold"), text_color=("#15803d", "#4ade80")).pack(pady=(40, 8))
    ...
    def show_login_progress(self):
        ...
        ctk.CTkLabel(self, text="Đang đăng nhập...", font=("Segoe UI", 26, "bold"), text_color=("#1d4ed8", "#60a5fa")).pack(
            pady=(90, 10)
        )
        ctk.CTkLabel(
            self,
